...
![Portrait of Thomas Comber hanging on a wall]({{<"/assets/img/posts/thomas_comber.jpg> =50%" | url}} "Thomas Comber on the wall at Stonegrave Minster. Cordelia Beattie")
...
![Photo of Durham Cathedral western tower and cloisters with blue sky]({{<"/assets/img/posts/Cathedral_towers_geograph_JohnIllingworth_228813.jpg> =50%" | url}} "Durham Cathedral western tower and cloisters: <br>John Illingworth, CC-BY-SA")
...
![A marble memorial plaque on a cathedral wall]({{"</assets/img/posts/Durham_memorial_to_Robert_Thornton.JPG> =50%" | url}} "Memorial to Robert Thornton at Durham Cathedral. Cordelia Beattie.")
...
![A woman with shoulder length brown hair looks at an old book on a book stand in the library]({{"</assets/img/posts/cordelia_book_durham.jpg"> =50% | url }} "Cordelia Beattie with one of Thornton's Books, Durham Cathedral Library.")
...
![Photo of small book with damaged front cover]({{"</assets/img/posts/book-remembrances-outside-first-sighting.jpg"> =50% | url}} "Book of Remembrances: Derek Beattie")
