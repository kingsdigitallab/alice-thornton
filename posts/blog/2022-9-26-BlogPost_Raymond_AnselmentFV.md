...
![Image of Professor Raymond Anselment]({{"/assets/img/posts/Ray_Photo.jpg"|url}} "Professor Raymond Anselment, 1939-2022 <br>&copy; ST"){.media-left}
...
![Image of the interior of the Beinecke library]({{"/assets/img/posts/Beinecke_library_interior_WC.jpg"|url}} "Beinecke library interior <br>commons.wikimedia.org"){.media-right}
